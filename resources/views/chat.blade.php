...
<body>
    ...
    .listen('MessageSent', (e) => {
        console.log('📥 Real-time message received:', e.message.message); // Add this to debug
        // Show the message
        const messageDiv = document.createElement('div');
        messageDiv.className = 'mb-2 text-end';
        messageDiv.innerHTML = `<span class="badge bg-secondary">${e.message.text}</span>`;
    ...
    .error((err) => {
        ...
        console.error('❌ Channel error:', err); // Log any error
    });
